	...
	return (
		<Wrapper>
			...
			<div className="mx-auto grid grid-cols-4 gap-10 h-96 my-5 ">
				...
				<div className="h-full w-full bg-black/[0.3] rounded-md shadow-md  flex items-center justify-center">
					<div className="w-fit h-fit mx-auto my-auto">
						<Link
							className=" rounded-md bg-white/[0.6] text-xl px-8 py-4 "
							href={`/image-editor?url=${designData.designUrl}`}
						>
							create a product
						</Link>
					</div>
